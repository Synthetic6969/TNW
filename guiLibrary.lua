...
function library.new()
	...
	function temp:Create(class, props)
	...
	function temp:CreateWindow(options)
		...
		function window:AddToggle(text, callback)
			...
			local label = temp:Create("TextLabel", {
				Text =  text,
			...
			local button = temp:Create("TextButton", {
				Text = "OFF",
		...
		function window:AddLabel(text)
			...
			local button = temp:Create("TextLabel", {
				Text =  text,
		...
		function window:AddDropdown(options, callback)
			...
			callback = callback or function() end
			local dropdown = temp:Create("TextLabel", {
				Size = UDim2.new(1, -10, 0, 20);
				BackgroundTransparency = 0.75;
				BackgroundColor3 = options.boxcolor,
				TextColor3 = Color3.fromRGB(255, 255, 255);
			...
			local button = temp:Create("ImageButton",{
				BackgroundTransparency = 1;
			...
			button.MouseButton1Click:connect(function()
				...
				temp:Create('UIListLayout', {
					Name = 'Layout';
					Parent = frame;
				})
	
				for i, option in next, options do
					local selection = temp:Create('TextButton', {
						Text = option;
						BackgroundColor3 = Color3.fromRGB(40, 40, 40);
						TextColor3 = Color3.fromRGB(255, 255, 255);
						BorderSizePixel = 0;
