...
local library = loadstring(game:HttpGet("https://pastebin.com/raw/ufkE1zXT", true))():new()
local settings = library:CreateWindow({
    text = "Settings"
})
...
settings:AddToggle("Mod Logger", function(toggled)
    getgenv().ModLog = toggled
    updateSettings()
end)
settings:AddToggle("Hide Name", function(toggled)
...
settings:AddToggle("Safe Farm", function(toggled)
